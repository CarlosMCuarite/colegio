      ...
      {tab === 'perfil' && (
        <motion.form className="sige-card" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} onSubmit={guardarPerfil}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1.25rem' }}>
            <button type="button" onClick={() => avatarInputRef.current?.click()} disabled={subiendoAvatar}
              ...
              <input ref={avatarInputRef} type="file" accept="image/*" onChange={subirAvatar} style={{ display: 'none' }} />
            </button>
          </div>
