...
export default function TesisPage() {
  ...
  return <DashboardLayout title="Tesis · Medición de impacto" allowedRoles={['SUPERADMIN']}>
    ...
    <style jsx global>{`
      .tesis-shell{display:grid;gap:18px;padding-bottom:28px}.tesis-hero{display:flex;align-items:end;justify-content:space-between;gap:24px;padding:26px 28px;border-radius:18px;background:linear-gradient(125deg,var(--accent-strong),var(--accent));color:white;box-shadow:0 12px 30px color-mix(in srgb,var(--accent) 22%,transparent)}.tesis-hero h2{margin:4px 0;font-size:1.65rem}.tesis-hero p{margin:0;opacity:.82}.tesis-eyebrow{font-size:.7rem;font-weight:800;letter-spacing:.12em}.tesis-hero label{min-width:260px;font-size:.75rem;font-weight:700}.tesis-hero select{display:block;width:100%;margin-top:6px;background:white;color:#172033;border:0;border-radius:10px;padding:11px}.tesis-grid{display:grid;grid-template-columns:minmax(290px,380px) 1fr;gap:18px}.tesis-card{background:white;border:1px solid #dbe4f0;border-radius:16px;padding:20px;box-shadow:0 5px 16px rgba(15,23,42,.055)}.tesis-card-title{display:flex;align-items:center;gap:11px;margin-bottom:18px}.tesis-card-title>i{display:grid;place-items:center;flex:0 0 38px;width:38px;height:38px;border-radius:10px;background:var(--accent-soft);color:var(--accent);font-size:1.05rem}.tesis-card-title div{display:grid;min-width:0}.tesis-card-title small{color:#64748b;margin-top:2px;line-height:1.45}.tesis-form label{display:block;font-size:.78rem;font-weight:700;color:#334155;margin-bottom:13px}.tesis-form input,.tesis-form select,.tesis-form textarea{display:block;width:100%;margin-top:6px;border:1px solid #cbd5e1;border-radius:10px;padding:10px 11px;background:#fff;color:#0f172a}.tesis-input-row{display:grid;grid-template-columns:1fr 100px;gap:10px}.tesis-primary,.tesis-refresh{border:0;border-radius:10px;background:var(--accent);color:var(--school-on-accent,#fff);padding:10px 15px;font-weight:750;cursor:pointer}.tesis-refresh{margin-left:auto;flex:0 0 auto}.tesis-results{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;align-items:stretch}.tesis-result{display:flex;flex-direction:column;min-width:0;min-height:190px;border:1px solid #dbe4f0;border-radius:14px;padding:16px;background:linear-gradient(180deg,#fff,#fbfdff);box-shadow:0 2px 8px rgba(15,23,42,.035)}.tesis-result header{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;font-weight:700}.tesis-result header span{min-width:0;line-height:1.35;color:#172033}.tesis-result em{flex:0 0 auto;white-space:nowrap;font-size:.66rem;font-style:normal;font-weight:750;border-radius:999px;padding:4px 8px;background:#f1f5f9;color:#64748b}.tesis-result em.good{background:#dcfce7;color:#166534}.tesis-result em.bad{background:#fee2e2;color:#991b1b}.tesis-values{display:grid;grid-template-columns:1fr auto 1fr;align-items:center;gap:12px;margin:18px 0}.tesis-values>i{color:var(--accent)}.tesis-values div{display:grid;gap:3px}.tesis-values div:last-child{text-align:right}.tesis-values small,.tesis-result p{color:#64748b;font-size:.73rem}.tesis-values strong{font-size:1rem;color:#0f172a;white-space:nowrap}.tesis-result p{margin:auto 0 0;line-height:1.5}.tesis-warning{background:#fff7ed;color:#9a5707!important;padding:9px 10px;border-radius:9px;border:1px solid #ffedd5}.tesis-table{overflow:auto}.tesis-table table{width:100%;border-collapse:collapse;font-size:.8rem}.tesis-table th,.tesis-table td{text-align:left;padding:11px;border-bottom:1px solid #e2e8f0}.tesis-table th{color:#64748b;font-size:.69rem;text-transform:uppercase}.tesis-table button{border:0;background:#fee2e2;color:#b91c1c;border-radius:8px;padding:7px;cursor:pointer}@media(max-width:1180px){.tesis-results{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:850px){.tesis-hero{align-items:stretch;flex-direction:column}.tesis-hero label{min-width:0}.tesis-grid{grid-template-columns:1fr}.tesis-card-title{align-items:flex-start;flex-wrap:wrap}.tesis-refresh{margin-left:49px}}@media(max-width:620px){.tesis-results{grid-template-columns:1fr}.tesis-result{min-height:0}.tesis-refresh{width:calc(100% - 49px)}}@media(prefers-reduced-motion:reduce){*{animation:none!important;transition:none!important}}
    `}</style>
  </DashboardLayout>;
}
