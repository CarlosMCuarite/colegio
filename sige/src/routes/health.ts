...
router.get('/database', async (req, res) => {
  ...
  // El respaldo es idempotente: si no hubo cambios no crea otra versión y
  // conserva siempre la última recuperable. La ruta pública solo permite
  // iniciar esta operación acotada; restaurar/descargar exige Superadmin.
